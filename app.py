...
filters = st.text_input("Exclude rows containing these codes in 'MSG Flight' (comma separated):", "SKL,LFT,ZKZ,ZKV,ZKN,MDK,FDC,N87,N96,N72,N81,ZKR,N11,VHO,VHX,VHA,ZKX,ZKJ,ZKT")
